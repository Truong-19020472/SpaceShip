...
public class StartItemConfig : ScriptableObject
{
        public List<ConsumableConfig> consumableConfigs;
        public Dictionary<RarityItem, WeaponConfig> weaponConfigs;
    ...
    public class WeaponConfig
    {
        ...
        public int DamageValue(int ItemLevel, RarityItem ItemRarity)
        {
            if (ItemLevel < 0) ItemLevel = 0;
            float rarityMultiplier = 0;
            switch (ItemRarity)
            {
                case RarityItem.normal:
                    rarityMultiplier = 1;
                    break;
                case RarityItem.magic:
